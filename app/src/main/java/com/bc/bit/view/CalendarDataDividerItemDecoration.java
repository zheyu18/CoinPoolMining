...
public class CalendarDataDividerItemDecoration extends RecyclerView.ItemDecoration{
     ...
     * @param spanCount 列数
     * */
    public CalendarDataDividerItemDecoration(Context context, float interval, int spanCount) {
